...
#define LOW_PRECISION`),e}const gx={[Ga]:"SHADOWMAP_TYPE_PCF",[zs]:"SHADOWMAP_TYPE_VSM"};function _x(t){return gx[t.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const vx={[Tr]:"ENVMAP_TYPE_CUBE",[ns]:"ENVMAP_TYPE_CUBE",[co]:"ENVMAP_TYPE_CUBE_UV"};function xx(t){return t.envMap===!1?"ENVMAP_TYPE_CUBE":vx[t.envMapMode]||"ENVMAP_TYPE_CUBE"}const Sx={[ns]:"ENVMAP_MODE_REFRACTION"};function Mx(t){return t.envMap===!1?"ENVMAP_MODE_REFLECTION":Sx[t.envMapMode]||"ENVMAP_MODE_REFLECTION"}const Ex={[Bd]:"ENVMAP_BLENDING_MULTIPLY",[q0]:"ENVMAP_BLENDING_MIX",[Y0]:"ENVMAP_BLENDING_ADD"};function yx(t){return t.envMap===!1?"ENVMAP_BLENDING_NONE":Ex[t.combine]||"ENVMAP_BLENDING_NONE"}function Tx(t){const e=t.envMapCubeUVHeight;if(e===null)return null;const n=Math.log2(e)-2,i=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,n),112)),texelHeight:i,maxMip:n}}function bx(t,e,n,i){const r=t.getContext(),s=n.defines;let a=n.vertexShader,o=n.fragmentShader;const l=_x(n),c=xx(n),h=Mx(n),u=yx(n),d=Tx(n),m=lx(n),_=cx(s),S=r.createProgram();let p,f,y=n.glslVersion?"#version "+n.glslVersion+`
